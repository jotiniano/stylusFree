...
insert  into `cliente`(`idCliente`,`nombreCliente`,`apellidoCliente`,`fechaNacimiento`,`fechaUltimaVisita`,`correo`,`telefono`,`celular`,`estado`,`direccion`,`totalVisitas`,`idTipoUsuario`,`dni`) values (1,'cliente 1','apellidos 1','2013-02-20','2013-02-18 00:16:08','wwww@d.com','1234567876','123456787642',1,'los angeles mira 6576',1,4,'12345678');
...
insert  into `detalleticket`(`idDetalleTicket`,`idTicket`,`idServicio`,`precio`,`idUsuario`) values (1,1,1,'35.00',NULL),(2,1,2,'60.00',NULL),(3,2,1,'35.00',11);
...
insert  into `reserva`(`idReserva`,`idCliente`,`idUsuario`,`fechaInicio`,`fechaFin`,`descripcion`,`estado`,`fechaRegistro`) values (1,1,1,'2013-03-09 10:00:00','2013-03-09 11:00:00','ktktftkfkyugylyliububibuibuibui',1,'2013-02-18 00:22:19');
...
insert  into `ticket`(`idTicket`,`idUsuario`,`fechaCreacion`,`idCliente`,`total`) values (1,1,'2013-02-19 21:30:18',1,'95.00'),(2,1,'2013-02-19 22:27:28',1,'35.00');
...
LOCK TABLES `usuarioservicio` WRITE;

insert  into `usuarioservicio`(`idUsuarioServicio`,`idUsuario`,`idServicio`,`comision`,`fechaRegistro`) values (1,9,1,5.00,NULL),(2,9,2,10.00,NULL),(3,9,3,10.00,NULL),(4,9,4,5.00,NULL),(5,11,1,5.00,NULL);
